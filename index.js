...
function getFinals(data){
    const allFinals = data.filter((element) => element.Stage === 'Final')
...
// 2 paramaters array getfinalscb
...
console.log('task 4', getWinners(fifaData, getFinals));
    /* code here map/ condidtional home team goals > away team goals then we want home team name else we want away team goal*/
...
function getWinnersByYear(data, getFinalscb, getYearscb, getWinnerscb) {
    ...
    return years.map((year, index )=>`In ${year}, ${country[index]} won the world cup!`)
}
